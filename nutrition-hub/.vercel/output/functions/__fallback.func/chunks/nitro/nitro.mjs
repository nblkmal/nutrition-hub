...
const _VZi3lpVshNE3Sxs6mCdBoI0YCR6_Ltkb9DMVWCBgxU = (function(nitro) {
...
const plugins = [
  _VZi3lpVshNE3Sxs6mCdBoI0YCR6_Ltkb9DMVWCBgxU
];
...
const _35dsY7 = defineEventHandler((event) => {
  const db = getDb();
  event.context.db = db;
});
...
const _riOLKZ = defineCachedEventHandler(async (event) => {
...
const _lazy_yQNj0F = () => import('../routes/api/admin/analytics.mjs');
const _lazy_eumkx5 = () => import('../routes/api/categories/_categoryId_.mjs');
const _lazy_ktuYz5 = () => import('../routes/api/index.mjs');
...
const handlers = [
  { route: '', handler: _35dsY7, lazy: false, middleware: true, method: undefined },
  { route: '/api/admin/analytics', handler: _lazy_yQNj0F, lazy: true, middleware: false, method: undefined },
  { route: '/api/categories/:categoryId', handler: _lazy_eumkx5, lazy: true, middleware: false, method: undefined },
  { route: '/api/categories', handler: _lazy_ktuYz5, lazy: true, middleware: false, method: undefined },
  ...
  { route: '/**', handler: _lazy_QsMkud, lazy: true, middleware: false, method: undefined }
];
